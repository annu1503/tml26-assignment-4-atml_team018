...
API_KEY  = "120b00f66fa0d99ed1040e67d025da15"  # REPLACE WITH YOUR API KEY

TASK_ID   = "22-forging-task" #donot change

FILE_PATH = Path("/Users/anushkachoudhary/TML Assignment-4/tml2026_task4/submission_hybrid.zip")
...
try:
    ...
    print("THIS SUBMISSION SCORE:", body.get('score'))
    if submission_id:
